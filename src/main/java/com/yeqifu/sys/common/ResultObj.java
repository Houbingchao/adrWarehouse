...
public class ResultObj {
    ...
    public static final ResultObj CHECK_SUCCESS = new ResultObj(Constast.OK,"库存充足");
    public static final ResultObj CHECK_ERROR = new ResultObj(Constast.ERROR,"库存不足");

    public static final ResultObj CHECKNAME_SUCCESS = new ResultObj(Constast.OK,"没有重名");
    public static final ResultObj CHECKNAME_ERROR = new ResultObj(Constast.ERROR,"物品名称已存在！");
    public static final ResultObj CHECKNAMEING_ERROR = new ResultObj(Constast.ERROR,"检查物品名时发生错误");
