...
public class LoginController {
    ...
    @RequestMapping("login")
    public ResultObj login(UserVo userVo,HttpSession session){ //String code, ,HttpSession session
        ...
        //if (code!=null&&sessionCode.equals(code)){
            ...
            try {
               ...
               session.setAttribute("username", userVo.getLoginname()); // 假设用户名保存在user对象中
